# ~/.config/powershell/chezmoiAutocomplete.ps1
# ============================================================================
# Chezmoi dotfiles manager autocomplete for Powershell.
#
# On Windows, this file will be linked over to
# `$Env:USERPROFILE\Documents\WindowsPowershell\chezmoiAutocomplete.ps1` and
# `$Env:USERPROFILE\Documents\Powershell\chezmoiAutocomplete.ps1`
# after `chezmoi apply` by the script `../run_after_link-external.ps1.tmpl`.

<#
	.SYNOPSIS
		Chezmoi autocomplete script.
	.DESCRIPTION
		Chezmoi autocomplete script generated by `chezmoi completion powershell -o chezmoiAutocomplete.ps1`.
	.NOTES
		Leonardo Calbi
	.LINK
